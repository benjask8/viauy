...
<footer class="footer">
  <section class="footer-links-container">
    ...
    <nav class="footer-links">
      ...
      <a href="https://www.facebook.com/ViaUY" target="_blank" class="footer-links-a"><i
          class="fa-brands fa-facebook"></i> Facebook</a>
      <a href="https://twitter.com/ViaUY" target="_blank" class="footer-links-a"><i class="fa-brands fa-twitter"></i>
        Twitter</a>
      <a href="https://www.linkedin.com/company/viauy" target="_blank" class="footer-links-a"><i
